...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      const web3Key = (import.meta.env.VITE_WEB3FORMS_KEY || '').trim();
  ...
  const contactItems: ContactItem[] = [
    {
      icon: <Mail size={18} />,
      label: 'Standard_Email',
      value: 'tonyalidu@gmail.com',
        ...
        <div className="flex flex-col lg:flex-row gap-20">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-text-muted text-lg font-light leading-relaxed mb-16 max-w-md">
              Transmitting projects, ideas, or architectural inquiries. I respond to high-fidelity
              opportunities within 24 cycles.
            </p>
                ...
                <div key={i} className="flex flex-col gap-2">
                  ...
                  {item.href ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-sm font-mono text-zinc-400 hover:text-accent-primary transition-colors flex items-center gap-2"
                    >
