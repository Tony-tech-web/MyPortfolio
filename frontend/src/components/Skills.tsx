...
import { SkillCategory, RadarStat } from '../types/portfolio';
...
const TechnicalRadar: React.FC<TechnicalRadarProps> = ({ stats, color }) => {
  return (
    <div className="relative w-full aspect-square flex items-center justify-center p-4">
      ...
      <div className="absolute inset-x-0 -bottom-4 flex justify-between px-1">
        {stats.map((s, i) => (
          <span
            key={i}
            className="text-[5px] font-mono text-zinc-500 uppercase tracking-tighter w-4 text-center"
          >
            {s.label}
          </span>
        ))}
  ...
  const skillGroups: SkillCategory[] = [
    {
      ...
      description:
        'Component-driven, state-aware UI focusing on modularity and declarative state reconciliation.',
      stats: [
    ...
    },
    {
      ...
      description:
        'Scalable service orchestration with robust database synchronization and caching layers.',
      stats: [
    ...
    },
    {
      ...
      description:
        'Local-first development workflows with containerized isolation and cloud-managed services.',
      stats: [
    ...
    },
    {
      ...
      description:
        'A multi-paradigm technical toolkit spanning low-level logic to high-level orchestrations.',
      stats: [
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              <p className="text-text-muted text-lg leading-relaxed mb-12 max-w-lg font-light">
                From architectural orchestration to final deployment, my stack is engineered for
                friction-less excellence and technical precision.
              </p>
              ...
              <div className="space-y-6">
                {skillGroups.map((group, i) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="terminal-label text-[10px] text-zinc-500 mb-1">
                        {group.category}
                      </p>
                      <p className="text-sm font-medium group-hover:text-accent-primary transition-colors">
                        {group.description}
                      </p>
                    </div>
                  </motion.div>
            ...
            <div className="relative w-full max-w-[450px] flex flex-col justify-center gap-6">
              {skillGroups.map((group, i) => (
                ...
                >
                  ...
                  <motion.h3 layout="position" className="text-xl font-bold tracking-tight mb-4">
                    {group.category}
                  </motion.h3>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Activity
                        ...
                        className={`${
                          expandedGroup === group.id
                            ? 'animate-pulse text-accent-primary'
